          ...
          {selectedConversation ? (
            <>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className='flex flex-col min-w-0'>
                          ...
                          {/* 消息气泡 */}
                          <div
                            className={`relative px-3 py-2.5 rounded shadow-lg backdrop-blur-sm transition-all duration-200 hover:shadow-xl ${
                              isOwnMessage
                                ? 'bg-blue-500 text-white shadow-blue-500/25'
                                : 'bg-white/90 dark:bg-gray-700/90 text-gray-900 dark:text-white shadow-gray-900/10 dark:shadow-black/20 ring-1 ring-gray-200/50 dark:ring-gray-600/50'
                            }`}
                          >
              ...
              <div className='relative p-3'>
                <div className='bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl shadow-sm'>
                  {/* 表情选择器 - 绝对定位，不占据文档流空间 */}
                  {showEmojiPicker && (
                  ...
                  <div className='p-3'>
                    {/* 顶部工具栏 */}
                    <div className='flex items-center justify-between pb-2 mb-2 border-b border-dashed border-gray-200 dark:border-gray-600'>
                      {/* 左侧功能按钮组 */}
                    ...
                    <div>
                      <div className='flex items-end gap-2'>
                        <textarea
                          ...
                          className='flex-1 px-3 py-2 bg-transparent border-0 focus:outline-none placeholder-gray-400 dark:placeholder-gray-400 resize-none min-h-[40px] max-h-28 transition-all duration-200'
                          rows={1}
                          maxLength={1000}
                          style={{ height: 'auto' }}
                          onInput={(e) => {
                        ...
                        <button
                          ...
                          className='p-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded transition-all duration-200 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex-shrink-0'
                          title={
                            !newMessage.trim()
                              ? '请输入消息内容'
                              : '发送消息 (Enter)'
