      ...
      <div className='relative w-full h-full'>
        {items.map((item, index) => (
          ...
          >
            ...
            {/* 标题 */}
            <div className='absolute bottom-0 left-0 right-0 pt-0 pb-10 px-6 sm:px-8 text-center sm:text-left'>
      ...
      {items.length > 1 && (
        <>
          <button
            ...
            className={`absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/50 hover:bg-blue-500/80 backdrop-blur-md rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105 ${
          ...
          <button
            onClick={goToNext}
            className={`absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/50 hover:bg-blue-500/80 backdrop-blur-md rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105 ${
              isHovered ? 'opacity-100' : 'opacity-0'
            }`}
          >
