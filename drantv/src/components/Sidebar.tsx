...
import { Cat, Clover,Film, Home, PanelLeftClose, PanelLeftOpen, PlayCircle, Radio, Star, Tv } from 'lucide-react';
          ...
          <div className='flex h-full flex-col'>
            ...
            <nav className='px-2'>
              <Link
                ...
                onClick={() => setActive('/')}
                data-active={active === '/'}
                className={`group flex ${isCollapsed ? 'items-center justify-center' : 'flex-col items-center justify-center'} rounded-lg px-2 py-2 text-gray-700 hover:bg-gray-100/30 hover:text-blue-600 data-[active=true]:bg-blue-500/20 data-[active=true]:text-blue-700 font-medium transition-colors duration-200 min-h-[40px] dark:text-gray-300 dark:hover:text-blue-400 dark:data-[active=true]:bg-blue-500/10 dark:data-[active=true]:text-blue-400 ${isCollapsed ? 'w-full' : ''} gap-1`}
            ...
            <div className='mt-auto px-2 pb-4'>
              <div className={`flex items-center justify-center pt-3 ${isCollapsed ? 'flex-col gap-3' : 'flex-row gap-4'}`}>
                <ThemeToggleButton />
                <button
