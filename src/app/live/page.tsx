...
import { ChevronLeft, Heart, Radio, Tv } from 'lucide-react';
...
function LivePageClient() {
  ...
  if (loading) {
    return (
      <PageLayout activePath='/live' disableMobileScroll={true}>
        <div className='flex items-center justify-center h-[calc(100dvh-3rem-4rem-env(safe-area-inset-bottom,0px))] -mt-12 -mb-[calc(4rem+env(safe-area-inset-bottom,0px))] md:min-h-[calc(100vh-3rem)] md:h-auto md:mt-0 md:mb-0'>
      ...
      >
        ...
        <div className='space-y-2'>
          ...
          <div className='hidden lg:flex justify-between items-center'>
            ...
            <button
              onClick={() => router.back()}
              className='p-2 flex items-center gap-1 text-gray-600 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400 transition-colors'
              aria-label='Back'
            >
            ...
            <div>
              <button
                ...
                className='group relative flex items-center gap-[3px] px-3 py-1.5 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-all duration-200'
            ...
            >
              <div className='md:ml-2 px-4 py-0 h-full rounded-xl bg-black/10 dark:bg-white/5 flex flex-col border border-white/0 dark:border-white/30 overflow-hidden'>
                ...
                {activeTab === 'channels' && (
                  <>
                    {/* 分组标签 */}
                    <div className='flex items-center gap-4 mb-4 mt-1 -mx-6 px-6 flex-shrink-0'>
                      {/* 切换状态提示 */}
                      {isSwitchingSource && (
