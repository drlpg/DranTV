...
function SearchPageClient() {
  ...
  return (
    <PageLayout
      ...
      noPadding={!showResults && searchHistory.length === 0}
    >
      <div
        className={`px-4 sm:px-10 transition-all duration-500 ${
          !showResults && searchHistory.length === 0
            ? 'h-full overflow-hidden md:min-h-[calc(100vh-3rem)] md:h-auto md:overflow-visible flex items-center justify-center'
