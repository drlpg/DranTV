                ...
                {categories
                  ...
                  ?.options.map((option) => (
                    <button
                      ...
                      className={`px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm rounded-lg transition-all duration-200 flex items-center justify-center ${
